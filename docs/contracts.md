...
- 오류: `429 { "error": "요청이 너무 많습니다. 잠시 후 다시 시도해주세요." }` (IP당 분당 5회 초과)
...
- 오류: `429 { "error": "요청이 너무 많습니다. 잠시 후 다시 시도해주세요." }` (IP당 분당 10회 초과)
...
- 요청: `{ "book_id": 1 }`
- 성공: `201 { "success": true }`
- 오류: `400 { "error": "book_id는 필수입니다" }` (book_id 없음)
- 오류: `400 { "error": "완독한 책만 컬렉션에 추가할 수 있습니다" }` (status !== '완독')
- 오류: `403 { "error": "권한이 없습니다" }` (컬렉션 또는 책이 해당 사용자 것이 아님)
